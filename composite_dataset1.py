...
if __name__ == '__main__':
  if len(sys.argv)<3:
    print "usage:python composite_dataset.py image_id result_location";
    exit();
    
  case_id= sys.argv[1];#image_id or case_id 
  #user=sys.argv[2];
  my_home=sys.argv[2];#computing result location
  ...
  print case_id,user,execution_id,new_execution_id;
  #exit();     
  ...
  print "total_algorithms number %d " % total_algorithms ; 
